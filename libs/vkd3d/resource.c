        ...
        UINT src_row_pitch, UINT src_slice_pitch)
{
    ...
    TRACE("Offset %"PRIxPTR", row pitch %"PRIxPTR", depth pitch %"PRIxPTR".\n",
        ...
        const D3D12_DESCRIPTOR_HEAP_DESC *desc, struct d3d12_descriptor_heap **descriptor_heap)
{
    ...
    if (desc->Flags & D3D12_DESCRIPTOR_HEAP_FLAG_SHADER_VISIBLE)
    {
        ...
        {
            WARN("Unsupported descriptor count %u for heap type %u (max %"PRIuPTR").\n", desc->NumDescriptors, desc->Type, max_descriptor_count);
            return E_INVALIDARG;
        }
    }
    else
...
void d3d12_descriptor_heap_cleanup(struct d3d12_descriptor_heap *descriptor_heap)
{
    ...
    if (d3d12_device_use_descriptor_heap(device))
    {
            ...
            (descriptor_heap->desc.Flags & D3D12_DESCRIPTOR_HEAP_FLAG_SHADER_VISIBLE))
        {
            ...
            {
                FIXME("Mismatch in meta descriptors. Expected VKD3D_DESCRIPTOR_HEAP_META_DESCRIPTOR_COUNT, got %"PRIuPTR".\n",
